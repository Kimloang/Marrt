...
const ProductCard: React.FC<Props> = ({ product, onAdd, isFavorite, onToggleFavorite }) => {
  return (
    <div className="flex flex-col gap-2 group">
      <div className="relative w-full aspect-square bg-[#f3ede7] dark:bg-[#3d2f21] rounded-2xl overflow-hidden shadow-sm">
        <div 
